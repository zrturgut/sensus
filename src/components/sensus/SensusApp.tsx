...
import {
  ...
  Mic, Pencil, Plus, Search, ShieldCheck, Sparkles, Square, Target, Timer, Trash2, Waves, X,
} from "lucide-react";
...
function useAtmosphericPointer() {
  useEffect(() => {
    ...
    const selector = ".section-heading, .vision-hero, .voice-panel, .goal-builder, .insight-card, .agenda-card, .agenda-composer, .history-card, .settings-dialog, .listening-card, .empty-insights, .history-empty, .dash-progress";
    let frame = 0;
